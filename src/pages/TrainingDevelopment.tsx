...
const TrainingDevelopment: React.FC = () => (
  <div className="intro-content">
    ...
    <ul>
      <li><strong>Firefighting</strong> – Fire prevention, risk assessment, emergency response, and the use of advanced firefighting equipment.</li>
      <li><strong>Industrial Security</strong> – Safeguarding factories and warehouses through hazard identification, workplace safety regulations, and emergency response strategies.</li>
