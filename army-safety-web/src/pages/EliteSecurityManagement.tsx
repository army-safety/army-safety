...
const EliteSecurityManagement: React.FC = () => (
  <div className="glass-feature-container">
    ...
    <ul>
      ...
      <li><strong>Fire safety protocols</strong></li>
      <li><strong>Event security operations</strong></li>
      <li><strong>High-profile venue protection</strong></li>
    </ul>
    <p><strong>
      Our expertise ensures the highest level of security for corporate facilities, public gatherings, and VIP events.
    </strong></p>
  </div>
);

export default EliteSecurityManagement;
